...
def evaluate_detector(name, detector, X, fit_predict=False):
    ...
    if not fit_predict:
        ...
        mv_result = labelfree.mass_volume_curve(scores, X, n_thresholds=50, random_state=42)
...
def main():
    ...
    # Define detectors
    detectors = [
        ("Isolation Forest", IsolationForest(contamination=0.1, random_state=42), False),
